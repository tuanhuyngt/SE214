...
export class CarServiceProxy {
     ...
     * @return Success
     */
    cAR_Upd(input: CarDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Car/CAR_Upd";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCAR_Upd(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCAR_Upd(<any>response_);
                } catch (e) {
    ...
    protected processCAR_Upd(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    cAR_App(id: number | null | undefined, checkerId: string | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Car/CAR_App?";
        if (id !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCAR_App(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCAR_App(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCAR_App(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    cAR_ById(id: number | null | undefined): Observable<CarDto> {
        let url_ = this.baseUrl + "/api/Car/CAR_ById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCAR_ById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCAR_ById(<any>response_);
                } catch (e) {
                    return <Observable<CarDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CarDto>><any>_observableThrow(response_);
        }));
    }

    protected processCAR_ById(response: HttpResponseBase): Observable<CarDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CarDto.fromJS(resultData200) : new CarDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CarDto>(<any>null);
    }
     ...
     * @return Success
     */
    cAR_Ins(input: CarDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Car/CAR_Ins";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCAR_Ins(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCAR_Ins(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCAR_Ins(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    cAR_Del(id: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Car/CAR_Del?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCAR_Del(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCAR_Del(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCAR_Del(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    cAR_Search(input: CarDto | null | undefined): Observable<CarDto[]> {
        let url_ = this.baseUrl + "/api/Car/CAR_Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCAR_Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCAR_Search(<any>response_);
                } catch (e) {
                    return <Observable<CarDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCAR_Search(response: HttpResponseBase): Observable<CarDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getCurrentUserName(): Observable<string> {
        let url_ = this.baseUrl + "/api/Car/GetCurrentUserName";
        url_ = url_.replace(/[?&]$/, "");
...
export class DemoModelServiceProxy {
     ...
     * @return Success
     */
    dEMO_MODEL_Search(input: DemoModelDto | null | undefined): Observable<DemoModelDto[]> {
        let url_ = this.baseUrl + "/api/DemoModel/DEMO_MODEL_Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDEMO_MODEL_Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDEMO_MODEL_Search(<any>response_);
                } catch (e) {
    ...
    protected processDEMO_MODEL_Search(response: HttpResponseBase): Observable<DemoModelDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(DemoModelDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
     ...
     * @return Success
     */
    createDemo(input: DemoModelInput | null | undefined): Observable<DemoModelDto> {
        let url_ = this.baseUrl + "/api/DemoModel/CreateDemo";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateDemo(response: HttpResponseBase): Observable<DemoModelDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deleteDemo(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/DemoModel/DeleteDemo/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteDemo(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteDemo(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteDemo(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group10ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    group10_Xe_Insert(input: Group10XeDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group10/Group10_Xe_Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup10_Xe_Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup10_Xe_Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup10_Xe_Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group1EditLXServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    lOAIXE_Group1Edit(input: Group1LoaiXeDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group1EditLX/LOAIXE_Group1Edit";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLOAIXE_Group1Edit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLOAIXE_Group1Edit(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processLOAIXE_Group1Edit(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class Group2ThanhLyServiceProxy {
     ...
     * @return Success
     */
    tHANHLY_Group2Search(maXe: number | null | undefined): Observable<Group2SearchDto> {
        let url_ = this.baseUrl + "/api/Group2ThanhLy/THANHLY_Group2Search?";
        if (maXe !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTHANHLY_Group2Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTHANHLY_Group2Search(<any>response_);
                } catch (e) {
                    return <Observable<Group2SearchDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group2SearchDto>><any>_observableThrow(response_);
        }));
    }

    protected processTHANHLY_Group2Search(response: HttpResponseBase): Observable<Group2SearchDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Group2SearchDto.fromJS(resultData200) : new Group2SearchDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<Group2SearchDto>(<any>null);
    }
     ...
     * @return Success
     */
    tHANHLY_Group2ThanhLy(input: Group2ThanhLyDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group2ThanhLy/THANHLY_Group2ThanhLy";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTHANHLY_Group2ThanhLy(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTHANHLY_Group2ThanhLy(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processTHANHLY_Group2ThanhLy(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class Group2VatTuServiceProxy {
     ...
     * @return Success
     */
    vATTUTHEOXE_Group2Insert(input: Group2VatTuTheoXeInsert | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTUTHEOXE_Group2Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTUTHEOXE_Group2Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTUTHEOXE_Group2Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVATTUTHEOXE_Group2Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    vATTUTHEOXE_Group2Update(input: Group2VatTuTheoXeUpdate | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTUTHEOXE_Group2Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTUTHEOXE_Group2Update(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTUTHEOXE_Group2Update(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVATTUTHEOXE_Group2Update(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    vATTUTHEOXE_Group2Del(input: Group2VatTuTheoXeDelete | null | undefined): Observable<{ [key: string] : any; }> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTUTHEOXE_Group2Del(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTUTHEOXE_Group2Del(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVATTUTHEOXE_Group2Del(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    vATTU_Group2Insert(input: Group2VatTuInsertInput | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTU_Group2Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTU_Group2Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTU_Group2Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVATTU_Group2Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    vATTU_Group2Update(input: Group2VatTuUpdateInput | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTU_Group2Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTU_Group2Update(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTU_Group2Update(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVATTU_Group2Update(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    vATTU_Group2Search(input: Group2VatTuSearchInput | null | undefined): Observable<Group2VatTuSearch[]> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTU_Group2Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTU_Group2Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTU_Group2Search(<any>response_);
                } catch (e) {
                    return <Observable<Group2VatTuSearch[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group2VatTuSearch[]>><any>_observableThrow(response_);
        }));
    }

    protected processVATTU_Group2Search(response: HttpResponseBase): Observable<Group2VatTuSearch[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group2VatTuSearch.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group2VatTuSearch[]>(<any>null);
    }
     ...
     * @return Success
     */
    vATTU_Group2SearchById(ma: number | null | undefined): Observable<Group2VatTuSearch[]> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTU_Group2SearchById?";
        if (ma !== undefined)
            url_ += "Ma=" + encodeURIComponent("" + ma) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTU_Group2SearchById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTU_Group2SearchById(<any>response_);
                } catch (e) {
                    return <Observable<Group2VatTuSearch[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVATTU_Group2SearchById(response: HttpResponseBase): Observable<Group2VatTuSearch[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    vATTU_Group2ThanhLy(input: Group2VatTuThanhLyInput | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTU_Group2ThanhLy";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTU_Group2ThanhLy(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTU_Group2ThanhLy(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVATTU_Group2ThanhLy(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    vATTU_Group2ThanhLySearch(input: Group2VatTuSearchThanhLyInput | null | undefined): Observable<Group2VatTuSearchThanhLy[]> {
        let url_ = this.baseUrl + "/api/Group2VatTu/VATTU_Group2ThanhLySearch";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVATTU_Group2ThanhLySearch(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVATTU_Group2ThanhLySearch(<any>response_);
                } catch (e) {
                    return <Observable<Group2VatTuSearchThanhLy[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group2VatTuSearchThanhLy[]>><any>_observableThrow(response_);
        }));
    }

    protected processVATTU_Group2ThanhLySearch(response: HttpResponseBase): Observable<Group2VatTuSearchThanhLy[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group2VatTuSearchThanhLy.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group2VatTuSearchThanhLy[]>(<any>null);
    }
}
...
export class Group3BangGiaServiceProxy {
     ...
     * @return Success
     */
    bangGia_Group3Insert(input: Group3BangGiaDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group3BangGia/BangGia_Group3Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBangGia_Group3Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBangGia_Group3Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBangGia_Group3Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group3DeXuatServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    deXuat_Group3Insert(input: Group3DeXuatDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group3DeXuat/DeXuat_Group3Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeXuat_Group3Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeXuat_Group3Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeXuat_Group3Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group4LoaiXeServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group4LoaiXe/test";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    lOAIXE_Group4Search(input: Group4LoaiXeDto | null | undefined): Observable<Group4LoaiXeDto[]> {
        let url_ = this.baseUrl + "/api/Group4LoaiXe/LOAIXE_Group4Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLOAIXE_Group4Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLOAIXE_Group4Search(<any>response_);
                } catch (e) {
                    return <Observable<Group4LoaiXeDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group4LoaiXeDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processLOAIXE_Group4Search(response: HttpResponseBase): Observable<Group4LoaiXeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group4LoaiXeDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group4LoaiXeDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    lOAIXE_Group4SearchById(input: number | null | undefined): Observable<Group4LoaiXeDto> {
        let url_ = this.baseUrl + "/api/Group4LoaiXe/LOAIXE_Group4SearchById?";
        if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLOAIXE_Group4SearchById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLOAIXE_Group4SearchById(<any>response_);
                } catch (e) {
                    return <Observable<Group4LoaiXeDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processLOAIXE_Group4SearchById(response: HttpResponseBase): Observable<Group4LoaiXeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Group4LoaiXeDto.fromJS(resultData200) : new Group4LoaiXeDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    lOAIXE_Group4Delete(ma: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group4LoaiXe/LOAIXE_Group4Delete?";
        if (ma !== undefined)
            url_ += "ma=" + encodeURIComponent("" + ma) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLOAIXE_Group4Delete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLOAIXE_Group4Delete(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processLOAIXE_Group4Delete(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group5XeServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group5Xe/test";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    dEXUAT_Group5DisplaySuggestions(): Observable<Group5DeXuatDto[]> {
        let url_ = this.baseUrl + "/api/Group5Xe/DEXUAT_Group5DisplaySuggestions";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDEXUAT_Group5DisplaySuggestions(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDEXUAT_Group5DisplaySuggestions(<any>response_);
                } catch (e) {
                    return <Observable<Group5DeXuatDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group5DeXuatDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processDEXUAT_Group5DisplaySuggestions(response: HttpResponseBase): Observable<Group5DeXuatDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group5DeXuatDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group5DeXuatDto[]>(<any>null);
    }

    /**
     * @return Success
     */
    xe_Group5DisplayVehicles(): Observable<Group5XeDto[]> {
        let url_ = this.baseUrl + "/api/Group5Xe/Xe_Group5DisplayVehicles";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXe_Group5DisplayVehicles(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXe_Group5DisplayVehicles(<any>response_);
                } catch (e) {
                    return <Observable<Group5XeDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group5XeDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processXe_Group5DisplayVehicles(response: HttpResponseBase): Observable<Group5XeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group5XeDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group5XeDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    xE_Group5SearchByNumberPlate(numberPlate: string | null | undefined): Observable<Group5XeDto[]> {
        let url_ = this.baseUrl + "/api/Group5Xe/XE_Group5SearchByNumberPlate?";
        if (numberPlate !== undefined)
            url_ += "numberPlate=" + encodeURIComponent("" + numberPlate) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXE_Group5SearchByNumberPlate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXE_Group5SearchByNumberPlate(<any>response_);
                } catch (e) {
                    return <Observable<Group5XeDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processXE_Group5SearchByNumberPlate(response: HttpResponseBase): Observable<Group5XeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    xE_Group5SearchById(id: number | null | undefined): Observable<Group5XeDto> {
        let url_ = this.baseUrl + "/api/Group5Xe/XE_Group5SearchById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXE_Group5SearchById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXE_Group5SearchById(<any>response_);
                } catch (e) {
                    return <Observable<Group5XeDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processXE_Group5SearchById(response: HttpResponseBase): Observable<Group5XeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Group5XeDto.fromJS(resultData200) : new Group5XeDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    xE_Group5SearchByType(loaiXe: string | null | undefined): Observable<Group5XeDto[]> {
        let url_ = this.baseUrl + "/api/Group5Xe/XE_Group5SearchByType?";
        if (loaiXe !== undefined)
            url_ += "loaiXe=" + encodeURIComponent("" + loaiXe) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXE_Group5SearchByType(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXE_Group5SearchByType(<any>response_);
                } catch (e) {
                    return <Observable<Group5XeDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processXE_Group5SearchByType(response: HttpResponseBase): Observable<Group5XeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    xE_Group5SearchByBrandAndType(input: Group5XeDto | null | undefined): Observable<Group5XeDto[]> {
        let url_ = this.baseUrl + "/api/Group5Xe/XE_Group5SearchByBrandAndType";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXE_Group5SearchByBrandAndType(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXE_Group5SearchByBrandAndType(<any>response_);
                } catch (e) {
                    return <Observable<Group5XeDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processXE_Group5SearchByBrandAndType(response: HttpResponseBase): Observable<Group5XeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group6XeServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    xe_Group6Update(input: Group6UpdateCarDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group6Xe/Xe_Group6Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXe_Group6Update(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXe_Group6Update(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processXe_Group6Update(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group6Xe/test";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class Group7PheDuyetXeServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    group7SelectBangGia(input: number | null | undefined): Observable<Group7DeXuatBangGiaDto[]> {
        let url_ = this.baseUrl + "/api/Group7PheDuyetXe/Group7SelectBangGia?";
        if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup7SelectBangGia(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup7SelectBangGia(<any>response_);
                } catch (e) {
                    return <Observable<Group7DeXuatBangGiaDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group7DeXuatBangGiaDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGroup7SelectBangGia(response: HttpResponseBase): Observable<Group7DeXuatBangGiaDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group7DeXuatBangGiaDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group7DeXuatBangGiaDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    group7SelectDeXuat(input: number | null | undefined): Observable<Group7DeXuatDto[]> {
        let url_ = this.baseUrl + "/api/Group7PheDuyetXe/Group7SelectDeXuat?";
        if (input !== undefined)
            url_ += "input=" + encodeURIComponent("" + input) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup7SelectDeXuat(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup7SelectDeXuat(<any>response_);
                } catch (e) {
                    return <Observable<Group7DeXuatDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group7DeXuatDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGroup7SelectDeXuat(response: HttpResponseBase): Observable<Group7DeXuatDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group7DeXuatDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group7DeXuatDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    group7Approve(ma: number | null | undefined, mabanggia: number | null | undefined, lydo: string | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group7PheDuyetXe/Group7Approve?";
        if (ma !== undefined)
            url_ += "ma=" + encodeURIComponent("" + ma) + "&"; 
        if (mabanggia !== undefined)
            url_ += "mabanggia=" + encodeURIComponent("" + mabanggia) + "&"; 
        if (lydo !== undefined)
            url_ += "lydo=" + encodeURIComponent("" + lydo) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup7Approve(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup7Approve(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup7Approve(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    group7Reject(ma: number | null | undefined, lydo: string | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group7PheDuyetXe/Group7Reject?";
        if (ma !== undefined)
            url_ += "ma=" + encodeURIComponent("" + ma) + "&"; 
        if (lydo !== undefined)
            url_ += "lydo=" + encodeURIComponent("" + lydo) + "&"; 
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup7Reject(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup7Reject(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup7Reject(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group8ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group8/test";
        url_ = url_.replace(/[?&]$/, "");
...
export class Group9LoaiXeServiceProxy {
     ...
     * @return Success
     */
    lOAIXE_Group9Insert(input: Group9LoaiXeDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9LoaiXe/LOAIXE_Group9Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLOAIXE_Group9Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLOAIXE_Group9Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processLOAIXE_Group9Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CarDto implements ICarDto {
    ...
    carCode!: string | undefined;
    name!: string | undefined;
    color!: string | undefined;
    recordStatus!: string | undefined;
    makerId!: string | undefined;
    createDt!: moment.Moment | undefined;
    authStatus!: string | undefined;
    checkerId!: string | undefined;
    approveDt!: moment.Moment | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.createDt = data["createDt"] ? moment(data["createDt"].toString()) : <any>undefined;
            this.authStatus = data["authStatus"];
            this.checkerId = data["checkerId"];
            this.approveDt = data["approveDt"] ? moment(data["approveDt"].toString()) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["createDt"] = this.createDt ? this.createDt.toISOString() : <any>undefined;
        data["authStatus"] = this.authStatus;
        data["checkerId"] = this.checkerId;
        data["approveDt"] = this.approveDt ? this.approveDt.toISOString() : <any>undefined;
        return data; 
    }
}
...
export class Group10XeDto implements IGroup10XeDto {
    ...
    constructor(data?: IGroup10XeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group10XeDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group10XeDto();
        result.init(data);
        return result;
    }
...
export interface IGroup10XeDto {
    xe_MaLoaiXe: number | undefined;
    xe_Ten: string | undefined;
    xe_BienSo: string | undefined;
    xe_Gia: number | undefined;
...
export class Group1LoaiXeDto implements IGroup1LoaiXeDto {
    ma!: number | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.loaiXe_SoLuong = data["loaiXe_SoLuong"];
            this.loaiXe_TrangThai = data["loaiXe_TrangThai"];
            this.loaiXe_NgayTao = data["loaiXe_NgayTao"] ? moment(data["loaiXe_NgayTao"].toString()) : <any>undefined;
            this.loaiXe_NguoiTao = data["loaiXe_NguoiTao"];
            this.loaiXe_LoaiNhienLieu = data["loaiXe_LoaiNhienLieu"];
        }
    }

    static fromJS(data: any): Group1LoaiXeDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group1LoaiXeDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["loaiXe_SoLuong"] = this.loaiXe_SoLuong;
        data["loaiXe_TrangThai"] = this.loaiXe_TrangThai;
        data["loaiXe_NgayTao"] = this.loaiXe_NgayTao ? this.loaiXe_NgayTao.toISOString() : <any>undefined;
        data["loaiXe_NguoiTao"] = this.loaiXe_NguoiTao;
        data["loaiXe_LoaiNhienLieu"] = this.loaiXe_LoaiNhienLieu;
        return data; 
    }
}

export interface IGroup1LoaiXeDto {
    ma: number | undefined;
    loaiXe_Ten: string | undefined;
    loaiXe_Hang: string | undefined;
    loaiXe_DinhMucNhienLieu: number | undefined;
...
export class Group2SearchDto implements IGroup2SearchDto {
    ...
    constructor(data?: IGroup2SearchDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group2SearchDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group2SearchDto();
        result.init(data);
        return result;
    }
...
export interface IGroup2SearchDto {
    ma: number | undefined;
    xe_Ten: string | undefined;
    xe_BienSo: string | undefined;
    loaiXe_Hang: string | undefined;
...
export class Group2ThanhLyDto implements IGroup2ThanhLyDto {
    thanhLy_MaXe!: number | undefined;
    thanhLy_LyDo!: string;
    thanhLy_NguoiMua!: string;
    thanhLy_SoTien!: number;
    thanhLy_NguoiTao!: string;
    thanhLy_NgayTao!: moment.Moment;

    constructor(data?: IGroup2ThanhLyDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.thanhLy_MaXe = data["thanhLy_MaXe"];
            this.thanhLy_LyDo = data["thanhLy_LyDo"];
            this.thanhLy_NguoiMua = data["thanhLy_NguoiMua"];
            this.thanhLy_SoTien = data["thanhLy_SoTien"];
            this.thanhLy_NguoiTao = data["thanhLy_NguoiTao"];
            this.thanhLy_NgayTao = data["thanhLy_NgayTao"] ? moment(data["thanhLy_NgayTao"].toString()) : <any>undefined;
        }
    }

    static fromJS(data: any): Group2ThanhLyDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group2ThanhLyDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["thanhLy_MaXe"] = this.thanhLy_MaXe;
        data["thanhLy_LyDo"] = this.thanhLy_LyDo;
        data["thanhLy_NguoiMua"] = this.thanhLy_NguoiMua;
        data["thanhLy_SoTien"] = this.thanhLy_SoTien;
        data["thanhLy_NguoiTao"] = this.thanhLy_NguoiTao;
        data["thanhLy_NgayTao"] = this.thanhLy_NgayTao ? this.thanhLy_NgayTao.toISOString() : <any>undefined;
        return data; 
    }
}

export interface IGroup2ThanhLyDto {
    thanhLy_MaXe: number | undefined;
    thanhLy_LyDo: string;
    thanhLy_NguoiMua: string;
    thanhLy_SoTien: number;
...
export class Group2VatTuTheoXeInsert implements IGroup2VatTuTheoXeInsert {
    vatTuTheoXe_MaVatTu!: number | undefined;
    vatTuTheoXe_MaXe!: number | undefined;

    constructor(data?: IGroup2VatTuTheoXeInsert) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.vatTuTheoXe_MaVatTu = data["vatTuTheoXe_MaVatTu"];
            this.vatTuTheoXe_MaXe = data["vatTuTheoXe_MaXe"];
        }
    }

    static fromJS(data: any): Group2VatTuTheoXeInsert {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuTheoXeInsert();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["vatTuTheoXe_MaVatTu"] = this.vatTuTheoXe_MaVatTu;
        data["vatTuTheoXe_MaXe"] = this.vatTuTheoXe_MaXe;
        return data; 
    }
}

export interface IGroup2VatTuTheoXeInsert {
    vatTuTheoXe_MaVatTu: number | undefined;
    vatTuTheoXe_MaXe: number | undefined;
}

export class Group2VatTuTheoXeUpdate implements IGroup2VatTuTheoXeUpdate {
    vatTuTheoXe_Ma!: number | undefined;
    vatTuTheoXe_MaVatTu!: number | undefined;
    vatTuTheoXe_MaXe!: number | undefined;

    constructor(data?: IGroup2VatTuTheoXeUpdate) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.vatTuTheoXe_Ma = data["vatTuTheoXe_Ma"];
            this.vatTuTheoXe_MaVatTu = data["vatTuTheoXe_MaVatTu"];
            this.vatTuTheoXe_MaXe = data["vatTuTheoXe_MaXe"];
        }
    }

    static fromJS(data: any): Group2VatTuTheoXeUpdate {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuTheoXeUpdate();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["vatTuTheoXe_Ma"] = this.vatTuTheoXe_Ma;
        data["vatTuTheoXe_MaVatTu"] = this.vatTuTheoXe_MaVatTu;
        data["vatTuTheoXe_MaXe"] = this.vatTuTheoXe_MaXe;
        return data; 
    }
...
export interface IGroup2VatTuTheoXeUpdate {
    vatTuTheoXe_Ma: number | undefined;
    vatTuTheoXe_MaVatTu: number | undefined;
    vatTuTheoXe_MaXe: number | undefined;
}
...
export class Group2VatTuInsertInput implements IGroup2VatTuInsertInput {
    vatTu_Ten!: string | undefined;
    vatTu_SoLuong!: number | undefined;
    vatTu_MoTa!: string | undefined;
    vatTu_DonGia!: number | undefined;
    vatTu_NguoiTao!: string | undefined;

    constructor(data?: IGroup2VatTuInsertInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.vatTu_Ten = data["vatTu_Ten"];
            this.vatTu_SoLuong = data["vatTu_SoLuong"];
            this.vatTu_MoTa = data["vatTu_MoTa"];
            this.vatTu_DonGia = data["vatTu_DonGia"];
            this.vatTu_NguoiTao = data["vatTu_NguoiTao"];
        }
    }

    static fromJS(data: any): Group2VatTuInsertInput {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuInsertInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["vatTu_Ten"] = this.vatTu_Ten;
        data["vatTu_SoLuong"] = this.vatTu_SoLuong;
        data["vatTu_MoTa"] = this.vatTu_MoTa;
        data["vatTu_DonGia"] = this.vatTu_DonGia;
        data["vatTu_NguoiTao"] = this.vatTu_NguoiTao;
        return data; 
    }
}

export interface IGroup2VatTuInsertInput {
    vatTu_Ten: string | undefined;
    vatTu_SoLuong: number | undefined;
    vatTu_MoTa: string | undefined;
    vatTu_DonGia: number | undefined;
...
export class Group2VatTuUpdateInput implements IGroup2VatTuUpdateInput {
    ma!: number | undefined;
    vatTu_Ten!: string | undefined;
    vatTu_SoLuong!: number | undefined;
    vatTu_MoTa!: string | undefined;
    ...
    constructor(data?: IGroup2VatTuUpdateInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group2VatTuUpdateInput {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuUpdateInput();
        result.init(data);
        return result;
    }
...
export interface IGroup2VatTuUpdateInput {
    ma: number | undefined;
    vatTu_Ten: string | undefined;
    vatTu_SoLuong: number | undefined;
    vatTu_MoTa: string | undefined;
...
export class Group2VatTuSearchInput implements IGroup2VatTuSearchInput {
    vatTu_Ma!: number | undefined;
    vatTu_Ten!: string | undefined;
    vatTu_SoLuong!: number | undefined;
    vatTu_DonGia!: number | undefined;
    vatTu_TongGia!: number | undefined;
    vatTu_TrangThai!: string | undefined;

    constructor(data?: IGroup2VatTuSearchInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.vatTu_SoLuong = data["vatTu_SoLuong"];
            this.vatTu_DonGia = data["vatTu_DonGia"];
            this.vatTu_TongGia = data["vatTu_TongGia"];
            this.vatTu_TrangThai = data["vatTu_TrangThai"];
        }
    }

    static fromJS(data: any): Group2VatTuSearchInput {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuSearchInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["vatTu_SoLuong"] = this.vatTu_SoLuong;
        data["vatTu_DonGia"] = this.vatTu_DonGia;
        data["vatTu_TongGia"] = this.vatTu_TongGia;
        data["vatTu_TrangThai"] = this.vatTu_TrangThai;
        return data; 
    }
}

export interface IGroup2VatTuSearchInput {
    vatTu_Ma: number | undefined;
    vatTu_Ten: string | undefined;
    vatTu_SoLuong: number | undefined;
    vatTu_DonGia: number | undefined;
...
export class Group2VatTuSearch implements IGroup2VatTuSearch {
    ma!: number | undefined;
    vatTu_Ten!: string | undefined;
    vatTu_SoLuong!: number | undefined;
    vatTu_MoTa!: string | undefined;
    ...
    vatTu_TongGia!: number | undefined;
    vatTu_TrangThai!: string | undefined;
    vatTu_NgayTao!: moment.Moment | undefined;

    constructor(data?: IGroup2VatTuSearch) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.vatTu_TongGia = data["vatTu_TongGia"];
            this.vatTu_TrangThai = data["vatTu_TrangThai"];
            this.vatTu_NgayTao = data["vatTu_NgayTao"] ? moment(data["vatTu_NgayTao"].toString()) : <any>undefined;
        }
    }

    static fromJS(data: any): Group2VatTuSearch {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuSearch();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["vatTu_TongGia"] = this.vatTu_TongGia;
        data["vatTu_TrangThai"] = this.vatTu_TrangThai;
        data["vatTu_NgayTao"] = this.vatTu_NgayTao ? this.vatTu_NgayTao.toISOString() : <any>undefined;
        return data; 
    }
}

export interface IGroup2VatTuSearch {
    ma: number | undefined;
    vatTu_Ten: string | undefined;
    vatTu_SoLuong: number | undefined;
    vatTu_MoTa: string | undefined;
...
export class Group2VatTuThanhLyInput implements IGroup2VatTuThanhLyInput {
    thanhLyVatTu_MaVatTu!: number | undefined;
    thanhLyVatTu_SoTienThanhLy!: number | undefined;
    thanhLyVatTu_SoLuong!: number | undefined;
    thanhLyVatTu_LyDo!: string | undefined;
    thanhLyVatTu_NguoiTao!: string | undefined;

    constructor(data?: IGroup2VatTuThanhLyInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.thanhLyVatTu_MaVatTu = data["thanhLyVatTu_MaVatTu"];
            this.thanhLyVatTu_SoTienThanhLy = data["thanhLyVatTu_SoTienThanhLy"];
            this.thanhLyVatTu_SoLuong = data["thanhLyVatTu_SoLuong"];
            this.thanhLyVatTu_LyDo = data["thanhLyVatTu_LyDo"];
            this.thanhLyVatTu_NguoiTao = data["thanhLyVatTu_NguoiTao"];
        }
    }

    static fromJS(data: any): Group2VatTuThanhLyInput {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuThanhLyInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["thanhLyVatTu_MaVatTu"] = this.thanhLyVatTu_MaVatTu;
        data["thanhLyVatTu_SoTienThanhLy"] = this.thanhLyVatTu_SoTienThanhLy;
        data["thanhLyVatTu_SoLuong"] = this.thanhLyVatTu_SoLuong;
        data["thanhLyVatTu_LyDo"] = this.thanhLyVatTu_LyDo;
        data["thanhLyVatTu_NguoiTao"] = this.thanhLyVatTu_NguoiTao;
        return data; 
    }
}

export interface IGroup2VatTuThanhLyInput {
    thanhLyVatTu_MaVatTu: number | undefined;
    thanhLyVatTu_SoTienThanhLy: number | undefined;
    thanhLyVatTu_SoLuong: number | undefined;
    thanhLyVatTu_LyDo: string | undefined;
...
export class Group2VatTuSearchThanhLyInput implements IGroup2VatTuSearchThanhLyInput {
    thanhLyVatTu_Ma!: number | undefined;
    thanhLyVatTu_MaVatTu!: number | undefined;
    thanhLyVatTu_SoTienThanhLy!: number | undefined;
    thanhLyVatTu_SoLuong!: number | undefined;
    thanhLyVatTu_LyDo!: string | undefined;
    ...
    constructor(data?: IGroup2VatTuSearchThanhLyInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.thanhLyVatTu_Ma = data["thanhLyVatTu_Ma"];
            this.thanhLyVatTu_MaVatTu = data["thanhLyVatTu_MaVatTu"];
            this.thanhLyVatTu_SoTienThanhLy = data["thanhLyVatTu_SoTienThanhLy"];
            this.thanhLyVatTu_SoLuong = data["thanhLyVatTu_SoLuong"];
            this.thanhLyVatTu_LyDo = data["thanhLyVatTu_LyDo"];
    ...
    static fromJS(data: any): Group2VatTuSearchThanhLyInput {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuSearchThanhLyInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["thanhLyVatTu_Ma"] = this.thanhLyVatTu_Ma;
        data["thanhLyVatTu_MaVatTu"] = this.thanhLyVatTu_MaVatTu;
        data["thanhLyVatTu_SoTienThanhLy"] = this.thanhLyVatTu_SoTienThanhLy;
        data["thanhLyVatTu_SoLuong"] = this.thanhLyVatTu_SoLuong;
        data["thanhLyVatTu_LyDo"] = this.thanhLyVatTu_LyDo;
...
export interface IGroup2VatTuSearchThanhLyInput {
    thanhLyVatTu_Ma: number | undefined;
    thanhLyVatTu_MaVatTu: number | undefined;
    thanhLyVatTu_SoTienThanhLy: number | undefined;
    thanhLyVatTu_SoLuong: number | undefined;
...
export class Group2VatTuSearchThanhLy implements IGroup2VatTuSearchThanhLy {
    ma!: number | undefined;
    thanhLyVatTu_MaVatTu!: number | undefined;
    thanhLyVatTu_NgayThanhLy!: moment.Moment | undefined;
    thanhLyVatTu_NgayTao!: moment.Moment | undefined;
    thanhLyVatTu_NguoiTao!: string | undefined;
    thanhLyVatTu_SoTienThanhLy!: number | undefined;
    thanhLyVatTu_SoLuong!: number | undefined;
    thanhLyVatTu_LyDo!: string | undefined;

    constructor(data?: IGroup2VatTuSearchThanhLy) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.ma = data["ma"];
            this.thanhLyVatTu_MaVatTu = data["thanhLyVatTu_MaVatTu"];
            this.thanhLyVatTu_NgayThanhLy = data["thanhLyVatTu_NgayThanhLy"] ? moment(data["thanhLyVatTu_NgayThanhLy"].toString()) : <any>undefined;
            this.thanhLyVatTu_NgayTao = data["thanhLyVatTu_NgayTao"] ? moment(data["thanhLyVatTu_NgayTao"].toString()) : <any>undefined;
            this.thanhLyVatTu_NguoiTao = data["thanhLyVatTu_NguoiTao"];
            this.thanhLyVatTu_SoTienThanhLy = data["thanhLyVatTu_SoTienThanhLy"];
            this.thanhLyVatTu_SoLuong = data["thanhLyVatTu_SoLuong"];
            this.thanhLyVatTu_LyDo = data["thanhLyVatTu_LyDo"];
    ...
    static fromJS(data: any): Group2VatTuSearchThanhLy {
        data = typeof data === 'object' ? data : {};
        let result = new Group2VatTuSearchThanhLy();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["ma"] = this.ma;
        data["thanhLyVatTu_MaVatTu"] = this.thanhLyVatTu_MaVatTu;
        data["thanhLyVatTu_NgayThanhLy"] = this.thanhLyVatTu_NgayThanhLy ? this.thanhLyVatTu_NgayThanhLy.toISOString() : <any>undefined;
        data["thanhLyVatTu_NgayTao"] = this.thanhLyVatTu_NgayTao ? this.thanhLyVatTu_NgayTao.toISOString() : <any>undefined;
        data["thanhLyVatTu_NguoiTao"] = this.thanhLyVatTu_NguoiTao;
        data["thanhLyVatTu_SoTienThanhLy"] = this.thanhLyVatTu_SoTienThanhLy;
        data["thanhLyVatTu_SoLuong"] = this.thanhLyVatTu_SoLuong;
        data["thanhLyVatTu_LyDo"] = this.thanhLyVatTu_LyDo;
...
export interface IGroup2VatTuSearchThanhLy {
    ma: number | undefined;
    thanhLyVatTu_MaVatTu: number | undefined;
    thanhLyVatTu_NgayThanhLy: moment.Moment | undefined;
    thanhLyVatTu_NgayTao: moment.Moment | undefined;
...
export class Group3BangGiaDto implements IGroup3BangGiaDto {
    ...
    chuThau!: string[] | undefined;

    constructor(data?: IGroup3BangGiaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.soLuong = data["soLuong"];
            if (data["gia"] && data["gia"].constructor === Array) {
                this.gia = [];
                for (let item of data["gia"])
                    this.gia.push(item);
            }
            if (data["chuThau"] && data["chuThau"].constructor === Array) {
                this.chuThau = [];
                for (let item of data["chuThau"])
                    this.chuThau.push(item);
            }
        }
    }

    static fromJS(data: any): Group3BangGiaDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group3BangGiaDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["soLuong"] = this.soLuong;
        if (this.gia && this.gia.constructor === Array) {
            data["gia"] = [];
            for (let item of this.gia)
                data["gia"].push(item);
        }
        if (this.chuThau && this.chuThau.constructor === Array) {
            data["chuThau"] = [];
            for (let item of this.chuThau)
                data["chuThau"].push(item);
        }
        return data; 
    }
}

export interface IGroup3BangGiaDto {
    soLuong: number | undefined;
    gia: number[] | undefined;
    chuThau: string[] | undefined;
}

export class Group3DeXuatDto implements IGroup3DeXuatDto {
    deXuat_MaLoaiXe!: number | undefined;
    deXuat_TenXe!: string | undefined;
    deXuat_Mau!: string | undefined;
    deXuat_MucDich!: string | undefined;
    deXuat_LyDo!: string | undefined;
    deXuat_NguoiTao!: string | undefined;
    deXuat_SoLuong!: number | undefined;

    constructor(data?: IGroup3DeXuatDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.deXuat_MaLoaiXe = data["deXuat_MaLoaiXe"];
            this.deXuat_TenXe = data["deXuat_TenXe"];
            this.deXuat_Mau = data["deXuat_Mau"];
            this.deXuat_MucDich = data["deXuat_MucDich"];
            this.deXuat_LyDo = data["deXuat_LyDo"];
            this.deXuat_NguoiTao = data["deXuat_NguoiTao"];
            this.deXuat_SoLuong = data["deXuat_SoLuong"];
        }
    }

    static fromJS(data: any): Group3DeXuatDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group3DeXuatDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["deXuat_MaLoaiXe"] = this.deXuat_MaLoaiXe;
        data["deXuat_TenXe"] = this.deXuat_TenXe;
        data["deXuat_Mau"] = this.deXuat_Mau;
        data["deXuat_MucDich"] = this.deXuat_MucDich;
        data["deXuat_LyDo"] = this.deXuat_LyDo;
        data["deXuat_NguoiTao"] = this.deXuat_NguoiTao;
        data["deXuat_SoLuong"] = this.deXuat_SoLuong;
        return data; 
    }
}

export interface IGroup3DeXuatDto {
    deXuat_MaLoaiXe: number | undefined;
    deXuat_TenXe: string | undefined;
    deXuat_Mau: string | undefined;
    deXuat_MucDich: string | undefined;
...
export class Group4LoaiXeDto implements IGroup4LoaiXeDto {
    ma!: number | undefined;
    loaiXe_Ten!: string | undefined;
    loaiXe_Hang!: string | undefined;
    loaiXe_DinhMucNhienLieu!: number | undefined;
    ...
    constructor(data?: IGroup4LoaiXeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group4LoaiXeDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group4LoaiXeDto();
        result.init(data);
        return result;
    }
...
export interface IGroup4LoaiXeDto {
    ma: number | undefined;
    loaiXe_Ten: string | undefined;
    loaiXe_Hang: string | undefined;
    loaiXe_DinhMucNhienLieu: number | undefined;
...
export class Group5DeXuatDto implements IGroup5DeXuatDto {
    ma!: number | undefined;
    deXuat_MaLoaiXe!: number | undefined;
    deXuat_TenXe!: string | undefined;
    deXuat_Mau!: string | undefined;
    deXuat_MucDich!: string | undefined;
    deXuat_LyDo!: string | undefined;
    deXuat_TrangThai!: string | undefined;
    deXuat_NguoiTao!: string | undefined;
    deXuat_NgayTao!: moment.Moment | undefined;
    deXuat_MaBangGia!: number | undefined;
    deXuat_SoLuong!: number | undefined;
    deXuatBangGia_Gia!: number | undefined;
    deXuatBangGia_ChuThau!: string | undefined;

    constructor(data?: IGroup5DeXuatDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.deXuat_MucDich = data["deXuat_MucDich"];
            this.deXuat_LyDo = data["deXuat_LyDo"];
            this.deXuat_TrangThai = data["deXuat_TrangThai"];
            this.deXuat_NguoiTao = data["deXuat_NguoiTao"];
            this.deXuat_NgayTao = data["deXuat_NgayTao"] ? moment(data["deXuat_NgayTao"].toString()) : <any>undefined;
            this.deXuat_MaBangGia = data["deXuat_MaBangGia"];
            this.deXuat_SoLuong = data["deXuat_SoLuong"];
            this.deXuatBangGia_Gia = data["deXuatBangGia_Gia"];
            this.deXuatBangGia_ChuThau = data["deXuatBangGia_ChuThau"];
        }
    }

    static fromJS(data: any): Group5DeXuatDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group5DeXuatDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["deXuat_MucDich"] = this.deXuat_MucDich;
        data["deXuat_LyDo"] = this.deXuat_LyDo;
        data["deXuat_TrangThai"] = this.deXuat_TrangThai;
        data["deXuat_NguoiTao"] = this.deXuat_NguoiTao;
        data["deXuat_NgayTao"] = this.deXuat_NgayTao ? this.deXuat_NgayTao.toISOString() : <any>undefined;
        data["deXuat_MaBangGia"] = this.deXuat_MaBangGia;
        data["deXuat_SoLuong"] = this.deXuat_SoLuong;
        data["deXuatBangGia_Gia"] = this.deXuatBangGia_Gia;
        data["deXuatBangGia_ChuThau"] = this.deXuatBangGia_ChuThau;
        return data; 
    }
}

export interface IGroup5DeXuatDto {
    ma: number | undefined;
    deXuat_MaLoaiXe: number | undefined;
    deXuat_TenXe: string | undefined;
    deXuat_Mau: string | undefined;
...
export class Group5XeDto implements IGroup5XeDto {
    ma!: number | undefined;
    xe_Ten!: string | undefined;
    xe_BienSo!: string | undefined;
    xe_Gia!: number | undefined;
    ...
    static fromJS(data: any): Group5XeDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group5XeDto();
        result.init(data);
        return result;
    }
...
export class Group6UpdateCarDto implements IGroup6UpdateCarDto {
    ma!: number | undefined;
    xe_Ten!: string | undefined;
    xe_BienSo!: string | undefined;

    constructor(data?: IGroup6UpdateCarDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group6UpdateCarDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group6UpdateCarDto();
        result.init(data);
        return result;
    }
...
export interface IGroup6UpdateCarDto {
    ma: number | undefined;
    xe_Ten: string | undefined;
    xe_BienSo: string | undefined;
}

export class Group7DeXuatBangGiaDto implements IGroup7DeXuatBangGiaDto {
    ma!: number | undefined;
    deXuatBangGia_MaDeXuat!: number | undefined;
    deXuatBangGia_Gia!: number | undefined;
    deXuatBangGia_ChuThau!: string | undefined;

    constructor(data?: IGroup7DeXuatBangGiaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.ma = data["ma"];
            this.deXuatBangGia_MaDeXuat = data["deXuatBangGia_MaDeXuat"];
            this.deXuatBangGia_Gia = data["deXuatBangGia_Gia"];
            this.deXuatBangGia_ChuThau = data["deXuatBangGia_ChuThau"];
        }
    }

    static fromJS(data: any): Group7DeXuatBangGiaDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group7DeXuatBangGiaDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["ma"] = this.ma;
        data["deXuatBangGia_MaDeXuat"] = this.deXuatBangGia_MaDeXuat;
        data["deXuatBangGia_Gia"] = this.deXuatBangGia_Gia;
        data["deXuatBangGia_ChuThau"] = this.deXuatBangGia_ChuThau;
        return data; 
    }
...
export interface IGroup7DeXuatBangGiaDto {
    ma: number | undefined;
    deXuatBangGia_MaDeXuat: number | undefined;
    deXuatBangGia_Gia: number | undefined;
    deXuatBangGia_ChuThau: string | undefined;
...
export class Group7DeXuatDto implements IGroup7DeXuatDto {
    ma!: number | undefined;
    deXuat_MaLoaiXe!: number | undefined;
    deXuat_TenXe!: string | undefined;
    deXuat_Mau!: string | undefined;
    ...
    constructor(data?: IGroup7DeXuatDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group7DeXuatDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group7DeXuatDto();
        result.init(data);
        return result;
    }
...
export interface IGroup7DeXuatDto {
    ma: number | undefined;
    deXuat_MaLoaiXe: number | undefined;
    deXuat_TenXe: string | undefined;
    deXuat_Mau: string | undefined;
...
export class Group9LoaiXeDto implements IGroup9LoaiXeDto {
    ...
    constructor(data?: IGroup9LoaiXeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group9LoaiXeDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group9LoaiXeDto();
        result.init(data);
        return result;
    }
...
export interface IGroup9LoaiXeDto {
    ma: number | undefined;
    loaiXe_Ten: string | undefined;
    loaiXe_Hang: string | undefined;
    loaiXe_DinhMucNhienLieu: number | undefined;
